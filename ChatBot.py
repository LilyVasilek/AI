...
answers = {
    ...
    r"что ты умеешь\??": "Я могу отвечать на вопросы о времени, дате, выполнять простые вычисления. Знаю смешной анекдот!",
    ...
    r"расскажи анекдот": "Что говорит голубь, когда вводит не ту ссылку в гугле? 'Неправильный урл'.",
